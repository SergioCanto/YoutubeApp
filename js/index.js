...
function displayResults( responseJSON, keyword ){
    ...
    clickAnterior(results, responseJSON, keyword);
    clickSiguiente(results, responseJSON, keyword);

}

function clickAnterior(results, responseJSON, keyword){
...
function clickSiguiente(results, responseJSON, keyword){
